...
namespace Nervestaple.WebService.Repositories.security
{
    /// <summary>
    /// Provides the interface for the LDAP repository
    /// </summary>
    public interface IAccountRepository
    {
        /// <summary>
        /// Returns an Account instance for the account with the provided
        ...
        /// unique identifier is not present on the account repository.
        /// </summary>
